...
async fn download_file_task(
    ...
    if !response.status().is_success() {
        ...
        if task.url.contains("bmclapi2.bangbang93.com") {
            ...
            if task.url.contains("/assets/") {
                fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/assets", "https://resources.download.minecraft.net"));
            } else if task.url.contains("/fabric-meta/") {
                fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/fabric-meta", "https://meta.fabricmc.net"));
            } else if task.url.contains("/maven/") {
                if task.url.contains("/maven/net/minecraftforge/") || task.url.contains("/maven/de/oceanlabs/") {
                    fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/maven", "https://maven.minecraftforge.net"));
                } else if task.url.contains("/maven/net/fabricmc/") {
                    fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/maven", "https://maven.fabricmc.net"));
                } else if task.url.contains("/maven/net/neoforged/") {
                    fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/maven", "https://maven.neoforged.net/releases"));
                } else {
                    // Default to mojang libraries
                    fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com/maven", "https://libraries.minecraft.net"));
                }
                ...
                for repo in other_mavens.iter() {
                    let fallback_url = task.url.replace("https://bmclapi2.bangbang93.com/maven", repo);
                    if !fallbacks.contains(&fallback_url) {
                        fallbacks.push(fallback_url);
                    }
                }
            } else {
                fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com", "https://piston-meta.mojang.com"));
                fallbacks.push(task.url.replace("https://bmclapi2.bangbang93.com", "https://launchermeta.mojang.com"));
            }
